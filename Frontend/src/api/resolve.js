...
//夏日滤镜
export function addSummer(data) {
  return request({
    url: "/addSummer/",
    method: "post",
    data,
...
//冬日滤镜
export function addWinter(data) {
  return request({
    url: "/addWinter/",
    method: "post",
    data,
...
// 磨皮效果
export function addSmoothSkin(data) {
    return request({
    url: "/addSmoothSkin/",
    method: "post",
    data,
...
// 高斯滤波
export function addGaussianBlur(data) {
  return request({
    url: "/addGaussianBlur/",
    method: "post",
    data,
...
// 油画效果
export function addOilPaint(data) {
  return request({
    url: "/addOilPaint/",
    method: "post",
    data,
...
//马赛克效果
export function addMosaic(data) {
  return request({
    url: "/addMosaic/",
    method: "post",
    data,
